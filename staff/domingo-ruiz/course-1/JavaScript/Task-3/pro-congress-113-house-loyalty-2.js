...
let demRep = document.getElementById("demo");
demRep.textContent = democrats;

let repRep = document.getElementById("repu");
repRep.textContent = republicans;

let idRep = document.getElementById("inde");
...
function calculateTotal() {
  ...
  for (i=0;i<low10.length;i++) {
    ans.push((low10[i].total_votes) * (low10[i].votes_with_party_pct)
    )}
  console.log(ans);
...
//HEADER
 ...
 for (var i = 0; i < low10.length; i++) {
  ...
  let text3 = document.createTextNode(low10[i].votes_with_party_pct);
...
//HEADER
 ...
 for (var i = 0; i < high10.length; i++) {
  ...
  let text3 = document.createTextNode(high10[i].votes_with_party_pct);
