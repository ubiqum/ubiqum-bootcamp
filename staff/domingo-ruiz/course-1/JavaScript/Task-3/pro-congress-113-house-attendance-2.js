...
var houseArr = house.results[0].members;
                            ////////
// var partyMembers = [];
...
function houseAttTableHigh(houseAttHigh10) {
...
//HEADER
 ...
 for (var i = 0; i < houseAttHigh10.length; i++) {
  let link = document.createElement("a");
  link.setAttribute("href", houseAttHigh10[i].url)
  ...
  let text1 = document.createTextNode(houseAttHigh10[i].first_name + " " + (houseAttHigh10[i].middle_name || "") + " " + houseAttHigh10[i].last_name);
  link.appendChild(text1);

  let text2 = document.createTextNode(totalVotesHighAtt[i]);
  let text3 = document.createTextNode(houseAttHigh10[i].missed_votes_pct);
...
houseAttTableHigh(houseAttHigh10);
