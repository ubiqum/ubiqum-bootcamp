...
//  Numbers of Senators by Party % votes with Party
for(i = 0; i < membersArr.length; i++){
    if(membersArr[i].party === "R"){
        republicanArr.push(membersArr[i]);
        repLoyal += membersArr[i].votes_with_party_pct;
    }
    if(membersArr[i].party === "D"){
        democratArr.push(membersArr[i])
        demLoyal += membersArr[i].votes_with_party_pct;
    }
    if(membersArr[i].party === "ID"){
        independentArr.push(membersArr[i]);
        indLoyal += membersArr[i].votes_with_party_pct;
    }
}


repLoyal = repLoyal / republicanArr.length
repLoyal = repLoyal.toFixed(3);
demLoyal = demLoyal / democratArr.length
demLoyal = demLoyal.toFixed(3);
indLoyal = indLoyal / independentArr.length
indLoyal = indLoyal.toFixed(3);
...
document.getElementById("rep-perc").textContent = repLoyal;
document.getElementById("dem-perc").textContent = demLoyal;
document.getElementById("ind-perc").textContent = indLoyal;
