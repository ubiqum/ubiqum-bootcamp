...
// //// number of votes with party

let arrNumberPartyVotes = [];
for(i = 0; i < mostCloneMembersArr.length; i++){
  ...
  arrNumberPartyVotes.push(numberPartyVotes);
  }
for(i = 0; i < arrNumberPartyVotes.length; i++){
  arrNumberPartyVotes[i] = arrNumberPartyVotes[i].toFixed(0);
}
console.log(arrNumberPartyVotes);
...
function buildTable(mostCloneMembersArr){
  ...
  for(i = 0; i < mostCloneMembersArr.length; i++){   
    ...
    let text2 = document.createTextNode(arrNumberPartyVotes[i]);
