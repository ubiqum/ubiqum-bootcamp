...
function buildTable(mostClonefilterMembersArr){
    ...
    for(i = 0; i < mostClonefilterMembersArr.length; i++){   
      ...
      let text2 = document.createTextNode(mostClonefilterMembersArr[i].missed_votes);
      let text3 = document.createTextNode(mostClonefilterMembersArr[i].missed_votes_pct + "%");    
  ...
  function buildTable2(leastClonefilterMembersArr){
    ...
    for(i = 0; i < leastClonefilterMembersArr.length; i++){   
      ...
      let text2 = document.createTextNode(leastClonefilterMembersArr[i].missed_votes);
      let text3 = document.createTextNode(leastClonefilterMembersArr[i].missed_votes_pct + "%");    
