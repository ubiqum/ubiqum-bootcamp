...
//Declare variables
//there are several members with 0 total votes, they need to be filtered out

let membersArr = data.results[0].members;
let filteredMembersArr = membersArr.filter(membersArr => membersArr.total_votes !== 0);
...
let bottomTenLoyals = filteredMembersArr;
let topTenLoyals = filteredMembersArr;
